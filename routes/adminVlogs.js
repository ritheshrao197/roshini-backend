...
router.post("/admin/vlogs", loginCheck, upload.single("thumbnail"), vlogController.postAddVlog);
router.put("/admin/vlogs/:id", loginCheck, upload.single("thumbnail"), vlogController.putUpdateVlog);
